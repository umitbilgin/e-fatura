...
require('number-to-text/converters/tr.js');
...
function xsltproc(args, options) {
    ...
    return new Promise((resolve, reject) => {
        const cmd = node_child_process.spawn(xsltprocExecutablePath, [
...
class XsltRenderer {
    ...
    async toXml() {
        ...
        const filename = path__namespace.basename(this.xsltFilePath);
     ...
     */
    getXsltContent() {
        return fs__namespace.readFile(this.xsltFilePath);
    }
    /**
     * XSLT şablonunun base64 ile kodlanmış içeriğini verir.
     */
    xsltToBase64Encoded() {
        return fs__namespace.readFile(this.xsltFilePath, 'base64url');
    }
    async render() {
        const xmlTmpFile = await tmpFileAsync();
        const xmlBuffer = await this.toXml();
        await fs__namespace.writeFile(xmlTmpFile.name, xmlBuffer, 'utf-8');
        return xsltproc([this.xsltFilePath, xmlTmpFile.name], this.xsltprocOptions).finally(() => xmlTmpFile.cleanup());
    }
}

const isTestEnv = process.env.NODE_ENV === 'test';
const allowLegacyRenegotiationForNodeJs = new https__namespace.Agent({
    secureOptions: crypto__namespace.constants.SSL_OP_LEGACY_SERVER_CONNECT
});
...
class EInvoiceApi {
    ...
    getInvoiceDownloadUrl(invoiceOrUuid, signed = true) {
        ...
        return `${this.getBaseURL()}/earsiv-services/download?${qs__namespace.stringify(query)}`;
    }
    /**
    ...
    async sendRequest(url, params, config) {
        ...
        const { data } = await axios.post(url, qs__namespace.stringify(params), getAxiosRequestConfig({
            ...config,
            baseURL,
            headers: {
...
exports.EInvoiceApi = EInvoiceApi;
exports.EInvoiceApiError = EInvoiceApiError;
exports.EInvoiceApiErrorCode = EInvoiceApiErrorCode$1;
exports.EInvoiceCountry = EInvoiceCountry$1;
exports.EInvoiceCurrencyType = EInvoiceCurrencyType$1;
exports.EInvoiceError = EInvoiceError;
exports.EInvoiceMissingCredentialsError = EInvoiceMissingCredentialsError;
exports.EInvoiceMissingTokenError = EInvoiceMissingTokenError;
exports.EInvoiceTypeError = EInvoiceTypeError;
exports.EInvoiceUnitType = EInvoiceUnitType$1;
exports.HourlySearchInterval = HourlySearchInterval$1;
exports.InvoiceApprovalStatus = InvoiceApprovalStatus$1;
exports.InvoiceType = InvoiceType$1;
exports.XsltRenderer = XsltRenderer;
exports.default = EInvoice;
exports.getDateFormat = getDateFormat;
exports.isEInvoiceApiResponseError = isEInvoiceApiResponseError;
exports.mappingBasicInvoiceIssuedToMeKeys = mappingBasicInvoiceIssuedToMeKeys;
exports.mappingBasicInvoiceKeys = mappingBasicInvoiceKeys;
exports.paymentPriceToText = paymentPriceToText;
